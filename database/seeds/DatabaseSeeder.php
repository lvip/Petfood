...
use App\Models\Role, App\Models\User, App\Models\Contact, App\Models\Post, App\Models\Tag, App\Models\PostTag, App\Models\Comment,
	App\Models\Food, App\Models\FoodAdditives, App\Models\Additives;
...
class DatabaseSeeder extends Seeder {
	...
	public function run()
	{
		...
		Post::create([
			'title' => 'Post 2',
			'slug' => 'post-2', 
			'summary' => '<img alt="" src="/filemanager/userfiles/greatredactor/m_6b5a69cb.jpg" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
...
', 
		...
		Post::create([
			'title' => 'Post 3',
			'slug' => 'post-3', 
			'summary' => '<img alt="" src="/filemanager/userfiles/greatredactor/3rJ97MvOHsY.jpg" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
			'content' => $lipsum->getContent(500), 
			'active' => true,
			'user_id' => 2
		]);
		...
		Post::create([
			'title' => 'Post 4',
			'slug' => 'post-4', 
			'summary' => '<img alt="" src="/filemanager/userfiles/greatredactor/kMO4btaFulA.jpg" style="float:left; height:128px; width:128px" />' . $lipsum->getContent(50),
			'content' => $lipsum->getContent(500), 
			'active' => true,
			'user_id' => 2
		]);
